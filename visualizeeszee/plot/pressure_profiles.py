...
class PlotPressureProfiles:
    ...
    def plot_pressure_profile(self, model_names=None, r_range=(1, 2000), n_points=200, 
        ...
        for model_name in model_names:
            ...
            if model_info.get('marginalized'): continue

            # Multi-component: parameters is a list — plot each component separately
            ...
            for comp_idx, comp_params in enumerate(params_list):
                suffix = f' (c{comp_idx})' if len(params_list) > 1 else ''
